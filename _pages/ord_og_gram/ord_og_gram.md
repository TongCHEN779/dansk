...
<head>
    ...
    <title>2D Axis for Mouth Shapes</title>
    <style>
        .audio-text {
            position: absolute;
            cursor: pointer;
...
<body>
    ...
    <script>
        ...
        const sounds = [
            ...
            { x: 0.7, y: 0.8, text: "æ", audioId: "i", audioSrc: "" },
            ...
            { x: 0.9, y: 0.9, text: "a", audioId: "i", audioSrc: "" },
            { x: 0.8, y: 0.3, text: "ə", audioId: "i", audioSrc: "" },
            { x: 1.0, y: 0.8, text: "ʌ", audioId: "i", audioSrc: "" },
            { x: 1.0, y: 0.6, text: "ɒ", audioId: "i", audioSrc: "" },
            { x: 1.0, y: 0.45, text: "ɔ", audioId: "i", audioSrc: "" },
            { x: 1.0, y: 0.3, text: "o", audioId: "i", audioSrc: "" },
            { x: 1.0, y: 0.1, text: "u", audioId: "i", audioSrc: "" }
        ];
        function drawAxis() {
